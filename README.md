...
* Travis: [![build status](https://travis-ci.org/erikvanoosten/metrics-scala.svg?branch=version-3.x-maintenance)](https://travis-ci.org/erikvanoosten/metrics-scala)
