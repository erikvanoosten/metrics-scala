...
<a href="CHANGELOG.md#v403-nov-2018">Release notes for 4.0.3.</a>
...
libraryDependencies ++= Seq(
  ...
  "nl.grons" %% "metrics4-akka_a24" % "4.0.3",
  "nl.grons" %% "metrics4-scala-hdr" % "4.0.3"
)
```
...
<properties>
    ...
    <metrics.scala.version>4.0.3</metrics.scala.version>
</properties>
<dependency>
