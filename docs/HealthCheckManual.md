**You are looking at the manual for version 3.x. [Manual for later versions](https://github.com/erikvanoosten/metrics-scala/tree/master/docs/HealthCheckManual.md)**
