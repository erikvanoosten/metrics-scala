...
import io.dropwizard.metrics5.health.{HealthCheckRegistry, SharedHealthCheckRegistries}
...
/**
  ...
  * }}}
  *
  * See [[BaseBuilder]] for instruction on overriding the metric base name.
  * See [[InstrumentedBuilder]] for instructions for using hdrhistograms.
