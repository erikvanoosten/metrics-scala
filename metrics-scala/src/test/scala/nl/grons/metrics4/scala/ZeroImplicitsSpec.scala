...
class ZeroImplicitsSpec extends org.scalatest.FlatSpec with ZeroImplicits {

  behavior of "ZeroImplicits"
  ...
  it should "define a zero for all Scala types" in {
    ...
    implicitly[Zero[Float]].zero shouldBe 0f
    implicitly[Zero[Double]].zero shouldBe 0d
  }
